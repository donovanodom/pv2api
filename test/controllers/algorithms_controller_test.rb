...
class AlgorithmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create algorithm" do
    assert_difference("Algorithm.count") do
      post algorithms_url, params: { algorithm: { code: @algorithm.code, content: @algorithm.content, title: @algorithm.title } }, as: :json
    end
  ...
  test "should update algorithm" do
    patch algorithm_url(@algorithm), params: { algorithm: { code: @algorithm.code, content: @algorithm.content, title: @algorithm.title } }, as: :json
    assert_response :success
  end
